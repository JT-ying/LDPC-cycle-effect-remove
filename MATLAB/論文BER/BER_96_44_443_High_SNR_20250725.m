% 定義SNR值
snr = [2.5, 2.75, 3.0, 3.25, 3.5];  % SNR值(dB)
% snr = [2.5, 2.75, 3.0, 3.25, 3.5, 3.75, 4.0];  % 多兩個高SNR比較
...
BER3_SNR0 = 0.0243750000;
BER3_SNR1 = 0.0166666667;
BER3_SNR2 = 0.0090277778;
BER3_SNR3 = 0.0054861111;
BER3_SNR4 = 0.0037500000;
% BER3_SNR5 = 0.0018958333;
% BER3_SNR6 = 0.0012708333;

% 定義LDPC方案4的BER值 (SPA iter = 100 觀察)
BER4_SNR0 = 0.0281944444;
BER4_SNR1 = 0.0199305556;
BER4_SNR2 = 0.0131250000;
BER4_SNR3 = 0.0084027778;
BER4_SNR4 = 0.0048958333;
% BER4_SNR5 = 0.0021250000;
% BER4_SNR6 = 0.0013750000;
...
BER3 = [BER3_SNR0, BER3_SNR1, BER3_SNR2, BER3_SNR3, BER3_SNR4];
BER4 = [BER4_SNR0, BER4_SNR1, BER4_SNR2, BER4_SNR3, BER4_SNR4];
